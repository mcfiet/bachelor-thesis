...
Außerdem fehlen auch hier, wie bei der Sparkasse, Labels bei den Suchfeldern. Dies verstößt gegen 4 WCAG-Kriterien 1.1.1 "Nicht-Text-Inhalt", 1.3.1 "Info und Beziehungen", 2.4.6 "Überschriften und Beschriftungen" und 3.3.2 "Labels oder Anleitungen". 
...
Auf den Unterseiten, wie die Fahrinfo, wiederholen sich die Kontrastfehler, da das Menü konstant auf den verschiedenen Seiten angelegt ist. Allerdings hat der iframe keinen zugänglichen Namen. Dies ist ein Verstoß gegen Kriterium 4.1.2 "Name, Rolle, Wert".
