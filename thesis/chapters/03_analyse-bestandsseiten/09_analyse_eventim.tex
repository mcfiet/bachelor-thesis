...
Die Eventim Startseite und ihre Unterseiten, wie die Veranstaltungsseite, wurden untersucht. Dabei trat ein verletztes Kriterium vermehrt auf. Das Kriterium 1.4.3 \enquote{Mindestkontrast} wurde so oft verletzt wie auf keiner anderen Website. Es sind also nicht nur einzelne Elemente betroffen, sondern bei der gesamten Gestaltung wurden die Kontrastverhältnisse nicht mit beachtet.
...
Und wie beim VBB auch, wurde kein zugänglicher Name für den iframe angegeben. Das ist ein Verstoß gegen Kriterium 4.1.2 \enquote{Name, Rolle, Wert}.
\begin{figure}[H]
