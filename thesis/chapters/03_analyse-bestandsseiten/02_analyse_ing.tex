...
Zusätzlich wurde das Scaling mit \codeinline{user-scalable=no} ausgeschaltet. Zu sehen in Abbildung 4.6.
...
Im Vergleich zur Sparkasse überschneiden sich die Fehler zum größten Teil. Bis auf den Scaling-Fehler betreffen die Fehler, die gefunden wurden, auch die Sparkasse. Dazu gehören die korrekte Verwendung von Aria-Atrributen, das Verständnis von dem Zweck eines Links und die richtige Semantik vom HTML. 
