...
Die Startseite weist eine geringe Anzahl an Fehlern auf. Ein Fehler tritt aber wiederholt auf. Dabei handelt es sich um einen Verstoß gegen Kriterium 1.3.1 \enquote{Info und Beziehungen}. Konkret werden Listenelemente \codeinline{<li>} nicht korrekt in einer Liste \codeinline{<ul>} oder \codeinline{<ol>} verwendet. Dabei ist das HTML-Element mit \codeinline{<li>} richtig angelegt, aber es wurde als \codeinline{role=\enquote{article}} deklariert. Somit wird die Liste nicht korrekt interpretiert.
...
Manche Fehler betreffen auch gleich mehrere Regeln. So wurde von WAVE festgestellt, dass es kein Label bei einem Suchfeld gibt. Dies verstößt gleich gegen 4 WCAG-Kriterien 1.1.1 \enquote{Nicht-Text-Inhalt}, 1.3.1 \enquote{Info und Beziehungen}, 2.4.6 \enquote{Überschriften und Beschriftungen} und 3.3.2 \enquote{Labels oder Anleitungen}.
