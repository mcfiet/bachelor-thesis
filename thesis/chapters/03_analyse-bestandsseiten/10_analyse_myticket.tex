...
Am häuftigsten wurde das Kriterium 2.4.7 "Fokus sichtbar" verletzt. Auch hier wurde der Fokus manuell getestet und ist auf vielen Elementen nicht vorhanden.

Danach folgt das Kriterium 2.4.4 \enquote{Link Zweck} und 4.1.2 "Name, Rolle, Wert". Dabei handelt es sich um Links, die keinen zugänglichen Namen haben.
