...
In der Gesamtbetrachtung der Analyse fällt auf, dass es nur zwei verletzte Kriterien, aber dort dann viele Fehler gibt. Das Kriterium 1.1.1 "Nicht-textueller Inhalt" ist mit Abstand am häufigsten betroffen. Das zweite Kriterium ist 4.1.2 "Name, Rolle, Wert". Hier geht es um die korrekte Benennung der Elemente.
