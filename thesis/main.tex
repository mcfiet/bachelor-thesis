...
\usepackage[numbers]{natbib}           % Für Zitationen
\bibliographystyle{abbrvnat}   % Bibliographiestil
\setcitestyle{authoryear,open={(},close={)}}  % Stil (Autor, Jahr) Zitierstil (Klammern)
...
\bibliography{bibliography.bib} % Literaturdatei hier angeben
